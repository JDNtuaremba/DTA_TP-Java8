...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        List<Person> result = filter(personList, p =  s -> s.getAge()>=18);
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        List<Person> result = filter(personList, p1 =  s -> s.getFirstname().equals("first_10"));
    ...
    public void test_filter_by_password() throws Exception {
        ...
        List<Person> result = filter(personList,p = s -> DigestUtils.sha512Hex(s.getPassword()).equals(passwordSha512Hex)&& s.getAge()>49);
